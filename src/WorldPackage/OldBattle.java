...
/**
 * Переделано на потоковый Battle.java
 * */
public class OldBattle extends Thread {
    int countHeroHit = 0;
    ...
    public OldBattle(int hHits, int hDamage, int hMiss,
    ...
    public static OldBattle startBattle(PlayerUnit playerHero, MonsterUnit monster) {
        ...
        return new OldBattle(countHitsOfHero, countOfHeroDamage, countHeroMiss,
